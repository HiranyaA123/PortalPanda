...
const MODULES = [
  {
    ...
    body: 'Not a template with your logo dropped in — a fast, beautiful ordering site built for your venue.',
    features: [
      ...
      'Pickup & delivery slots tied to your live hours.',
    ],
    Mock: MockOrder,
  },
  {
    ...
    body: 'Everything customers see and everything your team runs — from one dashboard you actually own.',
    features: [
  ...
  },
  {
    ...
    body: 'Staff get their own logins and portal on the shop tablet, separate from your owner dashboard.',
    features: [
      'Individual logins with role-based permissions.',
      'Built-in time clock — shifts on the same tablet.',
  ...
  },
  {
    ...
    features: [
      ...
      'Dockets print automatically on a Star printer.',
      'One tap to accept, mark ready, or hand over.',
      'Mark an item sold out — it vanishes from the site.',
    ],
    Mock: MockKitchen,
  },
  {
    ...
    features: [
      ...
      'Customers book in a few taps — no account.',
      'Every booking tied to the customer record.',
    ],
    Mock: MockBookings,
  },
  {
    ...
    body: 'Offer delivery without handing your customers, or 30% of every order, to a marketplace.',
    features: [
      ...
      <section className="section">
        <div className="container">
          <div className="section-head">
            ...
            <h2>Click through the whole platform.</h2>
            <p>Six modules, one system — every piece talks to every other piece in real time.</p>
          </div>
